/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c4ad33cf186fcea712f18c19043beb7c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		NOTES_VECTOR_INDEX: VectorizeIndex;
		VALUE_FROM_CLOUDFLARE: "Hello from Hono/CF";
		BODY_R2_THRESHOLD_BYTES: "65536";
		INDEX_CHUNK_MAX_CHARS: "900";
		INDEX_CHUNK_OVERLAP_CHARS: "120";
		INDEX_RETRY_MAX_ATTEMPTS: "5";
		INDEX_RETRY_BACKOFF_SECONDS: "30";
		INDEX_VECTOR_DIMENSIONS: "64";
		INDEX_EMBEDDING_MODEL: "hash-v1";
		TAG_NAME_MAX_LENGTH: "48";
		TAG_PER_NOTE_LIMIT: "12";
		AI_BASE_URL: "https://api.siliconflow.cn/v1";
		AI_CHAT_MODEL: "inclusionAI/Ling-flash-2.0";
		AI_EMBEDDING_MODEL: "Qwen/Qwen3-Embedding-0.6B";
		AI_EMBED_BATCH_SIZE: "8";
		AI_TIMEOUT_MS: "30000";
		AI_MAX_INPUT_CHARS: "12000";
		RSS_SYNC_FEED_LIMIT: "3";
		RSS_SYNC_ITEM_LIMIT: "10";
		RSS_TRANSLATE_ENABLED: "false";
		RSS_SYNC_TRANSLATE_BUDGET: "3";
		RSS_TRANSLATE_BATCH_LIMIT: "30";
		RSS_READING_PROCESS_LIMIT: "3";
		RSS_READING_USE_BROWSER_RENDERING: "true";
		RSS_READING_FETCH_TIMEOUT_MS: "30000";
		RSS_READING_MAX_CHARS: "40000";
		RSS_READING_TRANSLATE_CHUNK_CHARS: "3200";
		RSS_READING_TRANSLATE_MAX_CHUNKS: "8";
		RSS_READING_TRANSLATE_TIMEOUT_MS: "180000";
		RSS_READING_TRANSLATE_CHUNK_TIMEOUT_MS: "30000";
		RSS_READING_STALE_MINUTES: "10";
		RSS_CRON_ENABLED: "true";
		RSS_CRON_AUTO_TRANSLATE: "true";
		RSS_CRON_SYNC_FEED_LIMIT: "20";
		RSS_CRON_SYNC_ITEM_LIMIT: "10";
		RSS_CRON_TRANSLATE_LIMIT: "20";
		RSS_CRON_TRANSLATE_ROUNDS: "2";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "BODY_R2_THRESHOLD_BYTES" | "INDEX_CHUNK_MAX_CHARS" | "INDEX_CHUNK_OVERLAP_CHARS" | "INDEX_RETRY_MAX_ATTEMPTS" | "INDEX_RETRY_BACKOFF_SECONDS" | "INDEX_VECTOR_DIMENSIONS" | "INDEX_EMBEDDING_MODEL" | "TAG_NAME_MAX_LENGTH" | "TAG_PER_NOTE_LIMIT" | "AI_BASE_URL" | "AI_CHAT_MODEL" | "AI_EMBEDDING_MODEL" | "AI_EMBED_BATCH_SIZE" | "AI_TIMEOUT_MS" | "AI_MAX_INPUT_CHARS" | "RSS_SYNC_FEED_LIMIT" | "RSS_SYNC_ITEM_LIMIT" | "RSS_TRANSLATE_ENABLED" | "RSS_SYNC_TRANSLATE_BUDGET" | "RSS_TRANSLATE_BATCH_LIMIT" | "RSS_READING_PROCESS_LIMIT" | "RSS_READING_USE_BROWSER_RENDERING" | "RSS_READING_FETCH_TIMEOUT_MS" | "RSS_READING_MAX_CHARS" | "RSS_READING_TRANSLATE_CHUNK_CHARS" | "RSS_READING_TRANSLATE_MAX_CHUNKS" | "RSS_READING_TRANSLATE_TIMEOUT_MS" | "RSS_READING_TRANSLATE_CHUNK_TIMEOUT_MS" | "RSS_READING_STALE_MINUTES" | "RSS_CRON_ENABLED" | "RSS_CRON_AUTO_TRANSLATE" | "RSS_CRON_SYNC_FEED_LIMIT" | "RSS_CRON_SYNC_ITEM_LIMIT" | "RSS_CRON_TRANSLATE_LIMIT" | "RSS_CRON_TRANSLATE_ROUNDS">> {}
}
